...
import { Row, Col, Input, Form, Button, Label, FormGroup, Nav, TabContent, TabPane, NavItem, NavLink } from 'reactstrap';
...
const RecordVideoContent = (props) => {
                    ...
                    <TabPane tabId="3" className="preview-submit">
                        ...
                        <Col sm="12">
                            ...
                            :
                                ...
                                :
                                <span className="actionLink" onClick={submitVideo}>Upload video</span>
